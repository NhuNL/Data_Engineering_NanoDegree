...
# from I94_SAS_Lables_Description file which was provided in the workspace
# create a python dictionary in python, then create a country_udf
...
# country udf will return the country name based on the immigration codes
